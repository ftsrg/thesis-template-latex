...
\begin{lstlisting}[frame=single,float=!ht]
\newcommand{\vikszerzoA}{Bódis-Szomorú András}
\newcommand{\vikkonzulensA}{dr.~Konzulens Elemér}
\newcommand{\vikkonzulensB}{Második Konzulens}
...
%----------------------------------------------------------------------------
A főfejezetek külön \verb+content.tex+ könyvtárban foglalnak helyet. A sablonhoz 3 fejezet készült. További főfejezeteket úgy hozhatunk létre, ha új Tex fájlt készítünk a fejezet számára, és a \verb+diploma.tex+ fájlban, a \verb+\include+ és \verb+\includeonly+ utasítások argumentumába felvesszük az új \verb+.tex+ fájl nevét.
